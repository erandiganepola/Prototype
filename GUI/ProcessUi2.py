...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setGeometry(QtCore.QRect(210, 430, 111, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.lineEdit = QtGui.QLineEdit(Form)
        self.lineEdit.setGeometry(QtCore.QRect(202, 470, 111, 20))
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.lineEdit_2 = QtGui.QLineEdit(Form)
        self.lineEdit_2.setGeometry(QtCore.QRect(532, 470, 111, 20))
        self.lineEdit_2.setObjectName(_fromUtf8("lineEdit_2"))
        self.textEdit_2 = QtGui.QTextEdit(Form)
        self.textEdit_2.setGeometry(QtCore.QRect(335, 30, 315, 341))
        self.textEdit_2.setObjectName(_fromUtf8("textEdit_2"))
        self.label = QtGui.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(10, 465, 161, 31))
        self.label.setLineWidth(1)
        self.label.setWordWrap(True)
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtGui.QLabel(Form)
        self.label_2.setGeometry(QtCore.QRect(335, 465, 161, 31))
        self.label_2.setWordWrap(True)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.lineEdit_3 = QtGui.QLineEdit(Form)
        self.lineEdit_3.setGeometry(QtCore.QRect(202, 510, 111, 20))
        self.lineEdit_3.setObjectName(_fromUtf8("lineEdit_3"))
        self.lineEdit_4 = QtGui.QLineEdit(Form)
        self.lineEdit_4.setGeometry(QtCore.QRect(532, 510, 111, 20))
        self.lineEdit_4.setObjectName(_fromUtf8("lineEdit_4"))
        self.label_3 = QtGui.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(10, 505, 151, 31))
        self.label_3.setWordWrap(True)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_4 = QtGui.QLabel(Form)
        self.label_4.setGeometry(QtCore.QRect(335, 505, 151, 31))
        ...
        self.checkBox.setGeometry(QtCore.QRect(90, 400, 121, 17))
        self.checkBox.setObjectName(_fromUtf8("checkBox"))
        self.checkBox_2 = QtGui.QCheckBox(Form)
        self.checkBox_2.setGeometry(QtCore.QRect(460, 400, 121, 17))
        self.checkBox_2.setObjectName(_fromUtf8("checkBox_2"))
        self.checkBox_3 = QtGui.QCheckBox(Form)
        self.checkBox_3.setGeometry(QtCore.QRect(290, 400, 121, 17))
        self.checkBox_3.setObjectName(_fromUtf8("checkBox_3"))
        self.pushButton_2 = QtGui.QPushButton(Form)
        self.pushButton_2.setGeometry(QtCore.QRect(340, 430, 111, 23))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Jaccard Similarity using Bigrams", None))
        self.label_2.setText(_translate("Form", "Jaccard Similarity using Trigrams", None))
        self.label_3.setText(_translate("Form", "Cosine Similarity using Bigrams", None))
        self.label_4.setText(_translate("Form", "Cosine Similarity using Trigrams", None))
        self.label_5.setText(_translate("Form", "Document 1", None))
        self.label_6.setText(_translate("Form", "Document 2", None))
        self.checkBox.setText(_translate("Form", "Stopword Removal", None))
        self.checkBox_2.setText(_translate("Form", "Synonym Recognition", None))
        self.checkBox_3.setText(_translate("Form", "Lemmatization", None))
